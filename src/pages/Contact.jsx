    ...
    <>
      <div>
        <div class="mx-auto max-w-7xl px-4">
          <div class="mx-auto max-w-7xl py-12 md:py-16">
            <div class="grid items-center justify-items-center gap-x-4 gap--10 lg:grid-cols-2">
              <div class="flex items-center justify-center">
                <div class="px-2 md:px-12">
                  <p class="text-2xl font-bold text-[#0B72BF] md:text-4xl">
                    Get in touch
                  </p>
                  ...
                  <form action="" class="mt-8 space-y-4">
                    ...
                    <button
                      type="button"
                      class="w-full rounded-md bg-[#0B72BF] px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#0B72BF]/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
                    >
                      Send Message
                    </button>
                  </form>
