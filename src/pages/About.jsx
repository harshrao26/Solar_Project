    ...
    <div>
      <div class="mx-auto max-w-7xl px-4">
        <div class="flex flex-col space-y-8 pb-10 pt-12 md:pt-24">
          ...
          <p class="text-3xl font-bold text-[#0B72BF] md:text-5xl md:leading-10">
        ...
        <div class="my-8 flex flex-col gap-y-6 md:flex-row lg:justify-around">
          <div class="flex flex-col space-y-3 md:w-2/4 lg:w-1/5">
            ...
            <p class="text-sm font-medium">
              100, Electronic City Phase-1, Lucknow, 560100 IN
            </p>
          </div>
          <div class="flex flex-col space-y-3 md:w-2/4 lg:w-1/5">
            <svg
            ...
            <p class="w-full text-base text-gray-700">Mon-Sat 9am to 5pm.</p>
            <p class="text-sm font-medium">
              12th Main Rd, Indiranagar, Lucknow, 560008 IN
            </p>
          </div>
          <div class="flex flex-col space-y-3 md:w-2/4 lg:w-1/5">
            <svg
            ...
            <p class="w-full text-xl font-semibold  text-gray-900">office</p>
            <p class="w-full text-base text-gray-700">Mon-Sat 9am to 5pm.</p>
            <p class="text-sm font-medium">
              42, Residency Rd, Shanthala Nagar, Ashok Nagar, Lucknow, 560025 IN
            </p>
          </div>
        </div>
        <hr class="mt-20" />
        ...
        {/* <div class="flex flex-col items-center gap-x-4 gap-y-4 py-16 md:flex-row">
          <div class="space-y-6">
            <p class="text-sm font-semibold md:text-base">Contact →</p>
            <p class="text-3xl font-bold md:text-4xl">Get a ring?</p>
